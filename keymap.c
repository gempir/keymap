...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_ansi(
		...
		KC_NO, KC_NO, KC_NO, KX_EURO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KX_UMLAUT_U, KC_NO, KC_NO, KC_NO, 
		LT(1,KC_NO), KC_NO, KX_UMLAUT_S, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KX_UMLAUT_O, KX_UMLAUT_A, LCTL(KC_ENT), KC_NO, 
